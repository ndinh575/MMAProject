...
exports.register = async (req, res) => {
    try {
        const { username, password, role, email, phoneNumber, address, avatar } = req.body;
        ...
        // Create a new user
        const user = new User({ username, password: hashedPassword, role, email, phoneNumber, address, avatar });
        await user.save();
